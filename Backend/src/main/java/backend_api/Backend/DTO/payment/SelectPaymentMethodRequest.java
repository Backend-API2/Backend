...
public class SelectPaymentMethodRequest {
    ...
    @Pattern(regexp = "^(CREDIT_CARD|DEBIT_CARD|BANK_TRANSFER|CASH|MERCADO_PAGO)$", 
             message = "Payment method debe ser: CREDIT_CARD, DEBIT_CARD, BANK_TRANSFER, CASH, MERCADO_PAGO")
