...
public class CoreHubService {
    ...
    @Value("${core.hub.webhook.url:http://18.119.150.122:8081/api/core/webhook/payment-events}")
    private String webhookUrl;

    @Value("${core.hub.user.webhook.url:http://18.119.150.122:8081/api/core/webhook/user-events}")
    private String userWebhookUrl;

    @Value("${core.hub.matching.webhook.url:http://18.119.150.122:8081/api/core/webhook/matching-payment-requests}")
